...
namespace JulianAndHisDates
{
    ...
    public partial class JulianDateCalculatorForm : Form
    {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void DateTimePicker_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: dateTimePicker.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void DateTimePicker_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: dateTimePicker.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void CheckBoxIgnoreDecimals_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: checkBoxIgnoreDecimals.AccessibleDescription);
        #endregion
