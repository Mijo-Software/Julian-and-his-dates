using JulianAndHisDates.Properties;
using System;
...
namespace JulianAndHisDates
{
    ...
    public partial class JulianandhisdatesForm : Form
    {
        ...
        private static Properties.Settings GetDefault() => Settings.Default;
        ...
        private void JulianandhisdatesForm_Load(object sender, EventArgs e)
        {
            ...
            if (boolIsAlarmEnabled)
            {
                ...
                toolStripStatusLabelAlarm.Image = Resources.picSound;
                toolStripStatusLabelAlarm.Text = Resources.strAlarmOn;
            }
            else
            {
                boolIsAlarmEnabled = false;
                toolStripStatusLabelAlarm.Image = Resources.picSoundMute;
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            ...
            if (doubleNewJD < doubleOldJD)
            {
                ...
                {
                    using (SoundPlayer sound = new SoundPlayer(stream: Resources.wavBleep))
                    {
                        sound.Play();
                    }
        ...
        private void CheckBoxDarkLightMode_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (!boolFirstRun)
            {
                using (SoundPlayer sound = new SoundPlayer(Resources.wavBlop))
                {
                    sound.Play();
                }
            }
        ...
        {
            using (SoundPlayer sound = new SoundPlayer(stream: Resources.wavCameraFlashing))
            {
                sound.Play();
            }
            string
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelUtcTime_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelUtcTime.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelLocalTime_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelLocalTime.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelJulianDate_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelModifiedJulianDate_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelModifiedJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelReducedJulianDate_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelReducedJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelTruncatedJulianDate_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelTruncatedJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelDublinJulianDate_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelDublinJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelCnesJulianDate_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelCnesJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelCcsdsJulianDate_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelCcsdsJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelLopJulianDate_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelLopJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelMillenniumJulianDate_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelMillenniumJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelChronologicalJulianDate_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelChronologicalJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelChronologicalModifiedJulianDate_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelChronologicalModifiedJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelLilianDate_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelLilianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelRataDie_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelRataDie.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelMarsSolDate_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelMarsSolDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelUnixtime_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelUnixtime.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void CheckBoxAutomaticRefresh_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: checkBoxAutomaticRefresh.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void CheckBoxStayOnTop_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: checkBoxStayOnTop.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void CheckBoxDarkLightMode_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: checkBoxDarkLightMode.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelRefreshRateText_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: labelRefreshRateText.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void NumericUpDownRefreshRate_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: numericUpDownRefreshRate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ButtonMinimizeToTray_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: buttonMinimizeToTray.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ButtonInfo_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: buttonInfo.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ButtonRefresh_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: buttonRefresh.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ButtonOpenJulianDateCalculator_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: buttonOpenJulianDateCalculator.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ButtonOpenJulianDateConverter_Enter(object sender, EventArgs e) => SetStatusBar(
            strText: buttonOpenJulianDateConverter.AccessibleDescription);
        #endregion
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelUtcTimeText_MouseEnter(object sender, EventArgs e) => LabelUtcTimeText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelLocalTimeText_MouseEnter(object sender, EventArgs e) => LabelLocalTimeText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelJulianDateText_MouseEnter(object sender, EventArgs e) => LabelJulianDateText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelModifiedJulianDateText_MouseEnter(object sender, EventArgs e) => LabelModifiedJulianDateText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelReducedJulianDateText_MouseEnter(object sender, EventArgs e) => LabelReducedJulianDateText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelTruncatedJulianDateText_MouseEnter(object sender, EventArgs e) => LabelTruncatedJulianDateText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelDublinJulianDateText_MouseEnter(object sender, EventArgs e) => LabelDublinJulianDateText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelCnesJulianDateText_MouseEnter(object sender, EventArgs e) => LabelCnesJulianDateText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelCcsdsJulianDateText_MouseEnter(object sender, EventArgs e) => LabelCcsdsJulianDateText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelLopJulianDateText_MouseEnter(object sender, EventArgs e) => LabelLopJulianDateText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelMillenniumJulianDateText_MouseEnter(object sender, EventArgs e) => LabelMillenniumJulianDateText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelChronologicalJulianDateText_MouseEnter(object sender, EventArgs e) => LabelChronologicalJulianDateText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelChronologicalModifiedJulianDateText_MouseEnter(object sender, EventArgs e) => LabelChronologicalModifiedJulianDateText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelLilianDateText_MouseEnter(object sender, EventArgs e) => LabelLilianDateText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelRataDieText_MouseEnter(object sender, EventArgs e) => LabelRataDieText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelMarsSolDateText_MouseEnter(object sender, EventArgs e) => LabelMarsSolDateText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelUnixtimeText_MouseEnter(object sender, EventArgs e) => LabelUnixtimeText_Enter(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelUtcTime_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelUtcTime.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelLocalTime_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelLocalTime.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelJulianDate_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelModifiedJulianDate_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelModifiedJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelReducedJulianDate_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelReducedJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelTruncatedJulianDate_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelTruncatedJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelDublinJulianDate_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelDublinJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelCnesJulianDate_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelCnesJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelCcsdsJulianDate_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelCcsdsJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelLopJulianDate_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelLopJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelMillenniumJulianDate_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelMillenniumJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelChronologicalJulianDate_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelChronologicalJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelChronologicalModifiedJulianDate_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelChronologicalModifiedJulianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelLilianDate_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelLilianDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelRataDie_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelRataDie.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelMarsSolDate_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelMarsSolDate.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelUnixtime_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelUnixtime.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void CheckBoxAutomaticRefresh_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: checkBoxAutomaticRefresh.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void CheckBoxStayOnTop_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: checkBoxStayOnTop.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void CheckBoxDarkLightMode_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: checkBoxDarkLightMode.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelRefreshRateText_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: labelRefreshRateText.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ButtonMinimizeToTray_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: buttonMinimizeToTray.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ButtonInfo_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: buttonInfo.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ButtonRefresh_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: buttonRefresh.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ButtonOpenJulianDateCalculator_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: buttonOpenJulianDateCalculator.AccessibleDescription);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ButtonOpenJulianDateConverter_MouseEnter(object sender, EventArgs e) => SetStatusBar(
            strText: buttonOpenJulianDateConverter.AccessibleDescription);
        #endregion
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelUtcTimeText_MouseLeave(object sender, EventArgs e) => LabelUtcTimeText_Leave(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelLocalTimeText_MouseLeave(object sender, EventArgs e) => LabelLocalTimeText_Leave(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelJulianDateText_MouseLeave(object sender, EventArgs e) => LabelJulianDateText_Leave(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelModifiedJulianDateText_MouseLeave(object sender, EventArgs e) => LabelModifiedJulianDateText_Leave(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelReducedJulianDateText_MouseLeave(object sender, EventArgs e) => LabelReducedJulianDateText_Leave(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelTruncatedJulianDateText_MouseLeave(object sender, EventArgs e) => LabelTruncatedJulianDateText_Leave(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelDublinJulianDateText_MouseLeave(object sender, EventArgs e) => LabelDublinJulianDateText_Leave(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelCnesJulianDateText_MouseLeave(object sender, EventArgs e) => LabelCnesJulianDateText_Leave(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelCcsdsJulianDateText_MouseLeave(object sender, EventArgs e) => LabelCcsdsJulianDateText_Leave(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelLopJulianDateText_MouseLeave(object sender, EventArgs e) => LabelLopJulianDateText_Leave(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelMillenniumJulianDateText_MouseLeave(object sender, EventArgs e) => LabelMillenniumJulianDateText_Leave(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelChronologicalJulianDateText_MouseLeave(object sender, EventArgs e) => LabelChronologicalJulianDateText_Leave(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelChronologicalModifiedJulianDateText_MouseLeave(object sender, EventArgs e) => LabelChronologicalModifiedJulianDateText_Leave(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelLilianDateText_MouseLeave(object sender, EventArgs e) => LabelLilianDateText_Leave(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelRataDieText_MouseLeave(object sender, EventArgs e) => LabelRataDieText_Leave(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelMarsSolDateText_MouseLeave(object sender, EventArgs e) => LabelMarsSolDateText_Leave(
            sender: sender,
            e: e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LabelUnixtimeText_MouseLeave(object sender, EventArgs e) => LabelUnixtimeText_Leave(
            sender: sender,
            e: e);
