namespace JulianAndHisDates
{
  partial class JulianDateConverterForm
  {
    ...
    private void InitializeComponent()
    {
			...
			this.textboxJulianDate = new System.Windows.Forms.TextBox();
			this.textboxModifiedJulianDate = new System.Windows.Forms.TextBox();
			this.textboxReducedJulianDate = new System.Windows.Forms.TextBox();
			this.textboxTruncatedJulianDate = new System.Windows.Forms.TextBox();
			this.textboxDublinJulianDate = new System.Windows.Forms.TextBox();
			this.textboxCnesJulianDate = new System.Windows.Forms.TextBox();
			this.textboxCcsdsJulianDate = new System.Windows.Forms.TextBox();
			this.textboxMarsSolDate = new System.Windows.Forms.TextBox();
			this.textboxRataDie = new System.Windows.Forms.TextBox();
			this.textboxLilianDate = new System.Windows.Forms.TextBox();
			this.textboxChronologicalModifiedJulianDate = new System.Windows.Forms.TextBox();
			this.textboxChronologicalJulianDate = new System.Windows.Forms.TextBox();
			this.textboxMillenniumJulianDate = new System.Windows.Forms.TextBox();
			this.textboxLopJulianDate = new System.Windows.Forms.TextBox();
			this.textboxUnixtime = new System.Windows.Forms.TextBox();
			...
			// 
			this.labelChronologicalModifiedJulianDateText.AccessibleDescription = "Description of the Chronological Modified Julian Date";
			...
			// textboxJulianDate
			// 
			this.textboxJulianDate.AccessibleDescription = "Value of the Julian Date";
			this.textboxJulianDate.AccessibleName = "Julian Date Value";
			this.textboxJulianDate.AccessibleRole = System.Windows.Forms.AccessibleRole.Text;
			this.textboxJulianDate.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textboxJulianDate.Location = new System.Drawing.Point(183, 35);
			this.textboxJulianDate.Name = "textboxJulianDate";
			this.textboxJulianDate.Size = new System.Drawing.Size(101, 13);
			this.textboxJulianDate.TabIndex = 5;
			this.textboxJulianDate.Text = "[your Julian date here]";
			this.textboxJulianDate.TextChanged += new System.EventHandler(this.TextboxJulianDate_TextChanged);
			this.textboxJulianDate.Enter += new System.EventHandler(this.TextboxJulianDate_Enter);
			this.textboxJulianDate.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextboxJulianDate_KeyPress);
			this.textboxJulianDate.Leave += new System.EventHandler(this.TextboxJulianDate_Leave);
			this.textboxJulianDate.MouseEnter += new System.EventHandler(this.TextboxJulianDate_MouseEnter);
			this.textboxJulianDate.MouseLeave += new System.EventHandler(this.TextboxJulianDate_MouseLeave);
			// 
			// textboxModifiedJulianDate
			// 
			this.textboxModifiedJulianDate.AccessibleDescription = "Value of the Modified Julian Date";
			this.textboxModifiedJulianDate.AccessibleName = "Modified Julian Date Value";
			this.textboxModifiedJulianDate.AccessibleRole = System.Windows.Forms.AccessibleRole.Text;
			this.textboxModifiedJulianDate.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textboxModifiedJulianDate.Location = new System.Drawing.Point(183, 48);
			this.textboxModifiedJulianDate.Name = "textboxModifiedJulianDate";
			this.textboxModifiedJulianDate.Size = new System.Drawing.Size(101, 13);
			this.textboxModifiedJulianDate.TabIndex = 7;
			this.textboxModifiedJulianDate.Text = "[your Julian date here]";
			this.textboxModifiedJulianDate.TextChanged += new System.EventHandler(this.TextboxModifiedJulianDate_TextChanged);
			this.textboxModifiedJulianDate.Enter += new System.EventHandler(this.TextboxModifiedJulianDate_Enter);
			this.textboxModifiedJulianDate.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextboxModifiedJulianDate_KeyPress);
			this.textboxModifiedJulianDate.Leave += new System.EventHandler(this.TextboxModifiedJulianDate_Leave);
			this.textboxModifiedJulianDate.MouseEnter += new System.EventHandler(this.TextboxModifiedJulianDate_MouseEnter);
			this.textboxModifiedJulianDate.MouseLeave += new System.EventHandler(this.TextboxModifiedJulianDate_MouseLeave);
			// 
			// textboxReducedJulianDate
			// 
			this.textboxReducedJulianDate.AccessibleDescription = "Value of the Reduced Julian Date";
			this.textboxReducedJulianDate.AccessibleName = "Reduced Julian Date Value";
			this.textboxReducedJulianDate.AccessibleRole = System.Windows.Forms.AccessibleRole.Text;
			this.textboxReducedJulianDate.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textboxReducedJulianDate.Location = new System.Drawing.Point(183, 61);
			this.textboxReducedJulianDate.Name = "textboxReducedJulianDate";
			this.textboxReducedJulianDate.Size = new System.Drawing.Size(101, 13);
			this.textboxReducedJulianDate.TabIndex = 9;
			this.textboxReducedJulianDate.Text = "[your Julian date here]";
			this.textboxReducedJulianDate.TextChanged += new System.EventHandler(this.TextboxReducedJulianDate_TextChanged);
			this.textboxReducedJulianDate.Enter += new System.EventHandler(this.TextboxReducedJulianDate_Enter);
			this.textboxReducedJulianDate.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextboxReducedJulianDate_KeyPress);
			this.textboxReducedJulianDate.Leave += new System.EventHandler(this.TextboxReducedJulianDate_Leave);
			this.textboxReducedJulianDate.MouseEnter += new System.EventHandler(this.TextboxReducedJulianDate_MouseEnter);
			this.textboxReducedJulianDate.MouseLeave += new System.EventHandler(this.TextboxReducedJulianDate_MouseLeave);
			// 
			// textboxTruncatedJulianDate
			// 
			this.textboxTruncatedJulianDate.AccessibleDescription = "Value of the Truncated Julian Date";
			this.textboxTruncatedJulianDate.AccessibleName = "Truncated Julian Date Value";
			this.textboxTruncatedJulianDate.AccessibleRole = System.Windows.Forms.AccessibleRole.Text;
			this.textboxTruncatedJulianDate.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textboxTruncatedJulianDate.Location = new System.Drawing.Point(183, 74);
			this.textboxTruncatedJulianDate.Name = "textboxTruncatedJulianDate";
			this.textboxTruncatedJulianDate.Size = new System.Drawing.Size(101, 13);
			this.textboxTruncatedJulianDate.TabIndex = 11;
			this.textboxTruncatedJulianDate.Text = "[your Julian date here]";
			this.textboxTruncatedJulianDate.TextChanged += new System.EventHandler(this.TextboxTruncatedJulianDate_TextChanged);
			this.textboxTruncatedJulianDate.Enter += new System.EventHandler(this.TextboxTruncatedJulianDate_Enter);
			this.textboxTruncatedJulianDate.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextboxTruncatedJulianDate_KeyPress);
			this.textboxTruncatedJulianDate.Leave += new System.EventHandler(this.TextboxTruncatedJulianDate_Leave);
			this.textboxTruncatedJulianDate.MouseEnter += new System.EventHandler(this.TextboxTruncatedJulianDate_MouseEnter);
			this.textboxTruncatedJulianDate.MouseLeave += new System.EventHandler(this.TextboxTruncatedJulianDate_MouseLeave);
			// 
			// textboxDublinJulianDate
			// 
			this.textboxDublinJulianDate.AccessibleDescription = "Value of the Dublin Julian Date";
			this.textboxDublinJulianDate.AccessibleName = "Dublin Julian Date Value";
			this.textboxDublinJulianDate.AccessibleRole = System.Windows.Forms.AccessibleRole.Text;
			this.textboxDublinJulianDate.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textboxDublinJulianDate.Location = new System.Drawing.Point(183, 87);
			this.textboxDublinJulianDate.Name = "textboxDublinJulianDate";
			this.textboxDublinJulianDate.Size = new System.Drawing.Size(101, 13);
			this.textboxDublinJulianDate.TabIndex = 13;
			this.textboxDublinJulianDate.Text = "[your Julian date here]";
			this.textboxDublinJulianDate.TextChanged += new System.EventHandler(this.TextboxDublinJulianDate_TextChanged);
			this.textboxDublinJulianDate.Enter += new System.EventHandler(this.TextboxDublinJulianDate_Enter);
			this.textboxDublinJulianDate.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextboxDublinJulianDate_KeyPress);
			this.textboxDublinJulianDate.Leave += new System.EventHandler(this.TextboxDublinJulianDate_Leave);
			this.textboxDublinJulianDate.MouseEnter += new System.EventHandler(this.TextboxDublinJulianDate_MouseEnter);
			this.textboxDublinJulianDate.MouseLeave += new System.EventHandler(this.TextboxDublinJulianDate_MouseLeave);
			// 
			// textboxCnesJulianDate
			// 
			this.textboxCnesJulianDate.AccessibleDescription = "Value of the CNES Julian Date";
			this.textboxCnesJulianDate.AccessibleName = "CNES Julian Date Value";
			this.textboxCnesJulianDate.AccessibleRole = System.Windows.Forms.AccessibleRole.Text;
			this.textboxCnesJulianDate.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textboxCnesJulianDate.Location = new System.Drawing.Point(183, 100);
			this.textboxCnesJulianDate.Name = "textboxCnesJulianDate";
			this.textboxCnesJulianDate.Size = new System.Drawing.Size(101, 13);
			this.textboxCnesJulianDate.TabIndex = 15;
			this.textboxCnesJulianDate.Text = "[your Julian date here]";
			this.textboxCnesJulianDate.TextChanged += new System.EventHandler(this.TextboxCnesJulianDate_TextChanged);
			this.textboxCnesJulianDate.Enter += new System.EventHandler(this.TextboxCnesJulianDate_Enter);
			this.textboxCnesJulianDate.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextboxCnesJulianDate_KeyPress);
			this.textboxCnesJulianDate.Leave += new System.EventHandler(this.TextboxCnesJulianDate_Leave);
			this.textboxCnesJulianDate.MouseEnter += new System.EventHandler(this.TextboxCnesJulianDate_MouseEnter);
			this.textboxCnesJulianDate.MouseLeave += new System.EventHandler(this.TextboxCnesJulianDate_MouseLeave);
			// 
			// textboxCcsdsJulianDate
			// 
			this.textboxCcsdsJulianDate.AccessibleDescription = "Value of the CCSDS Julian Date";
			this.textboxCcsdsJulianDate.AccessibleName = "CCSDS Julian Date Value";
			this.textboxCcsdsJulianDate.AccessibleRole = System.Windows.Forms.AccessibleRole.Text;
			this.textboxCcsdsJulianDate.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textboxCcsdsJulianDate.Location = new System.Drawing.Point(183, 113);
			this.textboxCcsdsJulianDate.Name = "textboxCcsdsJulianDate";
			this.textboxCcsdsJulianDate.Size = new System.Drawing.Size(101, 13);
			this.textboxCcsdsJulianDate.TabIndex = 17;
			this.textboxCcsdsJulianDate.Text = "[your Julian date here]";
			this.textboxCcsdsJulianDate.TextChanged += new System.EventHandler(this.TextboxCcsdsJulianDate_TextChanged);
			this.textboxCcsdsJulianDate.Enter += new System.EventHandler(this.TextboxCcsdsJulianDate_Enter);
			this.textboxCcsdsJulianDate.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextboxCcsdsJulianDate_KeyPress);
			this.textboxCcsdsJulianDate.Leave += new System.EventHandler(this.TextboxCcsdsJulianDate_Leave);
			this.textboxCcsdsJulianDate.MouseEnter += new System.EventHandler(this.TextboxCcsdsJulianDate_MouseEnter);
			this.textboxCcsdsJulianDate.MouseLeave += new System.EventHandler(this.TextboxCcsdsJulianDate_MouseLeave);
			// 
			// textboxMarsSolDate
			// 
			this.textboxMarsSolDate.AccessibleDescription = "Value of the Mars Sol Date";
			this.textboxMarsSolDate.AccessibleName = "Mars Sol Date Value";
			this.textboxMarsSolDate.AccessibleRole = System.Windows.Forms.AccessibleRole.Text;
			this.textboxMarsSolDate.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textboxMarsSolDate.Location = new System.Drawing.Point(183, 204);
			this.textboxMarsSolDate.Name = "textboxMarsSolDate";
			this.textboxMarsSolDate.Size = new System.Drawing.Size(101, 13);
			this.textboxMarsSolDate.TabIndex = 31;
			this.textboxMarsSolDate.Text = "[your Julian date here]";
			this.textboxMarsSolDate.TextChanged += new System.EventHandler(this.TextboxMarsSolDate_TextChanged);
			this.textboxMarsSolDate.Enter += new System.EventHandler(this.TextboxMarsSolDate_Enter);
			this.textboxMarsSolDate.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextboxMarsSolDate_KeyPress);
			this.textboxMarsSolDate.Leave += new System.EventHandler(this.TextboxMarsSolDate_Leave);
			this.textboxMarsSolDate.MouseEnter += new System.EventHandler(this.TextboxMarsSolDate_MouseEnter);
			this.textboxMarsSolDate.MouseLeave += new System.EventHandler(this.TextboxMarsSolDate_MouseLeave);
			// 
			// textboxRataDie
			// 
			this.textboxRataDie.AccessibleDescription = "Value of the Rata Die";
			this.textboxRataDie.AccessibleName = "Rata Die Value";
			this.textboxRataDie.AccessibleRole = System.Windows.Forms.AccessibleRole.Text;
			this.textboxRataDie.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textboxRataDie.Location = new System.Drawing.Point(183, 191);
			this.textboxRataDie.Name = "textboxRataDie";
			this.textboxRataDie.Size = new System.Drawing.Size(101, 13);
			this.textboxRataDie.TabIndex = 29;
			this.textboxRataDie.Text = "[your Julian date here]";
			this.textboxRataDie.TextChanged += new System.EventHandler(this.TextboxRataDie_TextChanged);
			this.textboxRataDie.Enter += new System.EventHandler(this.TextboxRataDie_Enter);
			this.textboxRataDie.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextboxRataDie_KeyPress);
			this.textboxRataDie.Leave += new System.EventHandler(this.TextboxRataDie_Leave);
			this.textboxRataDie.MouseEnter += new System.EventHandler(this.TextboxRataDie_MouseEnter);
			this.textboxRataDie.MouseLeave += new System.EventHandler(this.TextboxRataDie_MouseLeave);
			// 
			// textboxLilianDate
			// 
			this.textboxLilianDate.AccessibleDescription = "Value of the Lilian Date";
			this.textboxLilianDate.AccessibleName = "Lilian Date Value";
			this.textboxLilianDate.AccessibleRole = System.Windows.Forms.AccessibleRole.Text;
			this.textboxLilianDate.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textboxLilianDate.Location = new System.Drawing.Point(183, 178);
			this.textboxLilianDate.Name = "textboxLilianDate";
			this.textboxLilianDate.Size = new System.Drawing.Size(101, 13);
			this.textboxLilianDate.TabIndex = 27;
			this.textboxLilianDate.Text = "[your Julian date here]";
			this.textboxLilianDate.TextChanged += new System.EventHandler(this.TextboxLilianDate_TextChanged);
			this.textboxLilianDate.Enter += new System.EventHandler(this.TextboxLilianDate_Enter);
			this.textboxLilianDate.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextboxLilianDate_KeyPress);
			this.textboxLilianDate.Leave += new System.EventHandler(this.TextboxLilianDate_Leave);
			this.textboxLilianDate.MouseEnter += new System.EventHandler(this.TextboxLilianDate_MouseEnter);
			this.textboxLilianDate.MouseLeave += new System.EventHandler(this.TextboxLilianDate_MouseLeave);
			// 
			// textboxChronologicalModifiedJulianDate
			// 
			this.textboxChronologicalModifiedJulianDate.AccessibleDescription = "Value of the Chronological Modified Julian Date";
			this.textboxChronologicalModifiedJulianDate.AccessibleName = "Chronological Modified Julian Date Value";
			this.textboxChronologicalModifiedJulianDate.AccessibleRole = System.Windows.Forms.AccessibleRole.Text;
			this.textboxChronologicalModifiedJulianDate.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textboxChronologicalModifiedJulianDate.Location = new System.Drawing.Point(183, 165);
			this.textboxChronologicalModifiedJulianDate.Name = "textboxChronologicalModifiedJulianDate";
			this.textboxChronologicalModifiedJulianDate.Size = new System.Drawing.Size(101, 13);
			this.textboxChronologicalModifiedJulianDate.TabIndex = 25;
			this.textboxChronologicalModifiedJulianDate.Text = "[your Julian date here]";
			this.textboxChronologicalModifiedJulianDate.TextChanged += new System.EventHandler(this.TextboxChronologicalModifiedJulianDate_TextChanged);
			this.textboxChronologicalModifiedJulianDate.Enter += new System.EventHandler(this.TextboxChronologicalModifiedJulianDate_Enter);
			this.textboxChronologicalModifiedJulianDate.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextboxChronologicalModifiedJulianDate_KeyPress);
			this.textboxChronologicalModifiedJulianDate.Leave += new System.EventHandler(this.TextboxChronologicalModifiedJulianDate_Leave);
			this.textboxChronologicalModifiedJulianDate.MouseEnter += new System.EventHandler(this.TextboxChronologicalModifiedJulianDate_MouseEnter);
			this.textboxChronologicalModifiedJulianDate.MouseLeave += new System.EventHandler(this.TextboxChronologicalModifiedJulianDate_MouseLeave);
			// 
			// textboxChronologicalJulianDate
			// 
			this.textboxChronologicalJulianDate.AccessibleDescription = "Value of the Chronological Julian Date";
			this.textboxChronologicalJulianDate.AccessibleName = "Chronological Julian Date Value";
			this.textboxChronologicalJulianDate.AccessibleRole = System.Windows.Forms.AccessibleRole.Text;
			this.textboxChronologicalJulianDate.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textboxChronologicalJulianDate.Location = new System.Drawing.Point(183, 152);
			this.textboxChronologicalJulianDate.Name = "textboxChronologicalJulianDate";
			this.textboxChronologicalJulianDate.Size = new System.Drawing.Size(101, 13);
			this.textboxChronologicalJulianDate.TabIndex = 23;
			this.textboxChronologicalJulianDate.Text = "[your Julian date here]";
			this.textboxChronologicalJulianDate.TextChanged += new System.EventHandler(this.TextboxChronologicalJulianDate_TextChanged);
			this.textboxChronologicalJulianDate.Enter += new System.EventHandler(this.TextboxChronologicalJulianDate_Enter);
			this.textboxChronologicalJulianDate.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextboxChronologicalJulianDate_KeyPress);
			this.textboxChronologicalJulianDate.Leave += new System.EventHandler(this.TextboxChronologicalJulianDate_Leave);
			this.textboxChronologicalJulianDate.MouseEnter += new System.EventHandler(this.TextboxChronologicalJulianDate_MouseEnter);
			this.textboxChronologicalJulianDate.MouseLeave += new System.EventHandler(this.TextboxChronologicalJulianDate_MouseLeave);
			// 
			// textboxMillenniumJulianDate
			// 
			this.textboxMillenniumJulianDate.AccessibleDescription = "Value of the Millenium Julian Date";
			this.textboxMillenniumJulianDate.AccessibleName = "Millennium Julian Date Value";
			this.textboxMillenniumJulianDate.AccessibleRole = System.Windows.Forms.AccessibleRole.Text;
			this.textboxMillenniumJulianDate.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textboxMillenniumJulianDate.Location = new System.Drawing.Point(183, 139);
			this.textboxMillenniumJulianDate.Name = "textboxMillenniumJulianDate";
			this.textboxMillenniumJulianDate.Size = new System.Drawing.Size(101, 13);
			this.textboxMillenniumJulianDate.TabIndex = 21;
			this.textboxMillenniumJulianDate.Text = "[your Julian date here]";
			this.textboxMillenniumJulianDate.TextChanged += new System.EventHandler(this.TextboxMillenniumJulianDate_TextChanged);
			this.textboxMillenniumJulianDate.Enter += new System.EventHandler(this.TextboxMillenniumJulianDate_Enter);
			this.textboxMillenniumJulianDate.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextboxMillenniumJulianDate_KeyPress);
			this.textboxMillenniumJulianDate.Leave += new System.EventHandler(this.TextboxMillenniumJulianDate_Leave);
			this.textboxMillenniumJulianDate.MouseEnter += new System.EventHandler(this.TextboxMillenniumJulianDate_MouseEnter);
			this.textboxMillenniumJulianDate.MouseLeave += new System.EventHandler(this.TextboxMillenniumJulianDate_MouseLeave);
			// 
			// textboxLopJulianDate
			// 
			this.textboxLopJulianDate.AccessibleDescription = "Value of the LOP Julian Date";
			this.textboxLopJulianDate.AccessibleName = "LOP Julian Date Value";
			this.textboxLopJulianDate.AccessibleRole = System.Windows.Forms.AccessibleRole.Text;
			this.textboxLopJulianDate.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textboxLopJulianDate.Location = new System.Drawing.Point(183, 126);
			this.textboxLopJulianDate.Name = "textboxLopJulianDate";
			this.textboxLopJulianDate.Size = new System.Drawing.Size(101, 13);
			this.textboxLopJulianDate.TabIndex = 19;
			this.textboxLopJulianDate.Text = "[your Julian date here]";
			this.textboxLopJulianDate.TextChanged += new System.EventHandler(this.TextboxLopJulianDate_TextChanged);
			this.textboxLopJulianDate.Enter += new System.EventHandler(this.TextboxLopJulianDate_Enter);
			this.textboxLopJulianDate.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextboxLopJulianDate_KeyPress);
			this.textboxLopJulianDate.Leave += new System.EventHandler(this.TextboxLopJulianDate_Leave);
			this.textboxLopJulianDate.MouseEnter += new System.EventHandler(this.TextboxLopJulianDate_MouseEnter);
			this.textboxLopJulianDate.MouseLeave += new System.EventHandler(this.TextboxLopJulianDate_MouseLeave);
			// 
			// textboxUnixtime
			// 
			this.textboxUnixtime.AccessibleDescription = "Value of the Unix Time";
			this.textboxUnixtime.AccessibleName = "Unix Time Value";
			this.textboxUnixtime.AccessibleRole = System.Windows.Forms.AccessibleRole.Text;
			this.textboxUnixtime.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textboxUnixtime.Location = new System.Drawing.Point(183, 217);
			this.textboxUnixtime.Name = "textboxUnixtime";
			this.textboxUnixtime.Size = new System.Drawing.Size(101, 13);
			this.textboxUnixtime.TabIndex = 33;
			this.textboxUnixtime.Text = "[your Julian date here]";
			this.textboxUnixtime.TextChanged += new System.EventHandler(this.TextboxUnixtime_TextChanged);
			this.textboxUnixtime.Enter += new System.EventHandler(this.TextboxUnixtime_Enter);
			this.textboxUnixtime.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextboxUnixTime_KeyPress);
			this.textboxUnixtime.Leave += new System.EventHandler(this.TextboxUnixtime_Leave);
			this.textboxUnixtime.MouseEnter += new System.EventHandler(this.TextboxUnixtime_MouseEnter);
			this.textboxUnixtime.MouseLeave += new System.EventHandler(this.TextboxUnixtime_MouseLeave);
			// 
			// statusStrip
			// 
			...
			// 
			this.AccessibleDescription = "Converts the Julian date to an other Julian date forn";
			this.AccessibleName = "Julian Date Converter";
			this.AccessibleRole = System.Windows.Forms.AccessibleRole.Window;
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.ClientSize = new System.Drawing.Size(303, 266);
			this.Controls.Add(this.statusStrip);
			this.Controls.Add(this.textboxUnixtime);
			this.Controls.Add(this.textboxMarsSolDate);
			this.Controls.Add(this.textboxRataDie);
			this.Controls.Add(this.textboxLilianDate);
			this.Controls.Add(this.textboxChronologicalModifiedJulianDate);
			this.Controls.Add(this.textboxChronologicalJulianDate);
			this.Controls.Add(this.textboxMillenniumJulianDate);
			this.Controls.Add(this.textboxLopJulianDate);
			this.Controls.Add(this.textboxCcsdsJulianDate);
			this.Controls.Add(this.textboxCnesJulianDate);
			this.Controls.Add(this.textboxDublinJulianDate);
			this.Controls.Add(this.textboxTruncatedJulianDate);
			this.Controls.Add(this.textboxReducedJulianDate);
			this.Controls.Add(this.textboxModifiedJulianDate);
			this.Controls.Add(this.textboxJulianDate);
			...
			this.Name = "JulianDateConverterForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "JD converter";
			this.Load += new System.EventHandler(this.JulianDateConverterForm_Load);
    ...
    private System.Windows.Forms.ToolTip toolTip;
		private System.Windows.Forms.TextBox textboxJulianDate;
		private System.Windows.Forms.TextBox textboxModifiedJulianDate;
		private System.Windows.Forms.TextBox textboxReducedJulianDate;
		private System.Windows.Forms.TextBox textboxTruncatedJulianDate;
		private System.Windows.Forms.TextBox textboxDublinJulianDate;
		private System.Windows.Forms.TextBox textboxCnesJulianDate;
		private System.Windows.Forms.TextBox textboxCcsdsJulianDate;
		private System.Windows.Forms.TextBox textboxMarsSolDate;
		private System.Windows.Forms.TextBox textboxRataDie;
		private System.Windows.Forms.TextBox textboxLilianDate;
		private System.Windows.Forms.TextBox textboxChronologicalModifiedJulianDate;
		private System.Windows.Forms.TextBox textboxChronologicalJulianDate;
		private System.Windows.Forms.TextBox textboxMillenniumJulianDate;
		private System.Windows.Forms.TextBox textboxLopJulianDate;
		private System.Windows.Forms.TextBox textboxUnixtime;
